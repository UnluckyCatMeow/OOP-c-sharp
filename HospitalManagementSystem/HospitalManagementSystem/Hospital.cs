...
namespace HospitalManagementSystem
{
    ...
    {
        public List<Doctor> Doctors { get; set; } //Doctors – список лікарів
        public List<Patient> Patients { get; set; } //– список пацієнтів
        public List<HospitalRoom> Rooms { get; set; } //– список палат
        public List<MedicalRecord> Records { get; set; } //– список медичних записів
