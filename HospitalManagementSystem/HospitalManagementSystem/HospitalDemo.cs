...
namespace HospitalManagementSystem
{
    public class HospitalDemo
    {
        public void Run()
        {
            ...
            Doctor doctor1 = new Doctor(1, "Олександр Гурський", "Хірург");
            Doctor doctor2 = new Doctor(2, "Микита Лесько", "Терапевт");
            Doctor doctor3 = new Doctor(3, "Андрій Придиренко", "Кардіолог");
            ...
            Patient patient1 = new Patient(1, "Ольга Погрібна", 23);
            Patient patient2 = new Patient(2, "Сергій Пода", 27);
            Patient patient3 = new Patient(3, "Олена Зорьова", 35);
            Patient patient4 = new Patient(4, "Іван Петренко", 64);
